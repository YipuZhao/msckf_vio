...
for ri, num_gf in enumerate(Number_GF_List):
    ...
    for iteration in range(0, Num_Repeating):
        ...
        for sn, sname in enumerate(SeqNameList):
            ...
            cmd_lmklog    = 'cp /mnt/DATA/msckf_tmpLog_lmk.txt ' + Experiment_dir + '/' + SeqName + '_Log_lmk.txt'
            cmd_timelog_1 = 'cp /mnt/DATA/msckf_tmpLog_front.txt ' + Experiment_dir + '/' + SeqName + '_Log_front.txt'
            cmd_timelog_2 = 'cp /mnt/DATA/msckf_tmpLog_back.txt ' + Experiment_dir + '/' + SeqName + '_Log_back.txt'
            cmd_tracklog  = 'cp /mnt/DATA/msckf_tmpTrack.txt ' + Experiment_dir + '/' + SeqName + '_AllFrameTrajectory.txt'
